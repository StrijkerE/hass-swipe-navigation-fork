...
class Logger {
    ...
    static logv(tag, msg) { Logger.log(tag, msg, LogLevel.VERBOSE); }
    static logd(tag, msg) { Logger.log(tag, msg, LogLevel.DEBUG); }
    static logi(tag, msg) { Logger.log(tag, msg, LogLevel.INFO); }
    static logw(tag, msg) { Logger.log(tag, msg, LogLevel.WARN); }
    static loge(tag, msg) { Logger.log(tag, msg, LogLevel.ERROR); }
    static log(tag, msg, level) {
...
Logger.loggerLevel = LogLevel._ALL;
...
class Config {
    constructor() {
        ...
        this.enable = true;
        this.enable_mouse_swipe = false;
        this.enable_on_subviews = true;
        ...
        this.logger_level = LogLevel.WARN;
        this.prevent_default = false;
        this.skip_hidden = true;
        this.skip_subviews = true;
        this.skip_tabs = [];
        this.swipe_amount = 0.15;
        this.wrap = true;
    }
    getAnimate() {
        return this.animate;
    ...
    static parseConfig(rawConfig) {
        ...
        if (rawConfig.animate != null) {
            newConfig.animate = rawConfig.animate;
        }
        if (rawConfig.animate_duration != null) {
            newConfig.animate_duration = rawConfig.animate_duration;
        }
        if (rawConfig.enable != null) {
            newConfig.enable = rawConfig.enable;
        }
        if (rawConfig.enable_mouse_swipe != null) {
            newConfig.enable_mouse_swipe = rawConfig.enable_mouse_swipe;
        }
        if (rawConfig.enable_on_subviews != null) {
            newConfig.enable_on_subviews = rawConfig.enable_on_subviews;
        }
        switch (rawConfig.logger_level) {
            ...
            case undefined:
                break;
            default: {
                const exhaustiveCheck = rawConfig.logger_level;
                throw new Error(`Unhandled case: ${exhaustiveCheck}`);
            }
        }
        if (rawConfig.prevent_default != null) {
            newConfig.prevent_default = rawConfig.prevent_default;
        }
        if (rawConfig.skip_hidden != null) {
            newConfig.skip_hidden = rawConfig.skip_hidden;
        }
        if (rawConfig.skip_subviews != null) {
            newConfig.skip_subviews = rawConfig.skip_subviews;
        }
        ...
        if (rawConfig.swipe_amount != null) {
            newConfig.swipe_amount = rawConfig.swipe_amount / 100.0;
        }
        if (rawConfig.wrap != null) {
            newConfig.wrap = rawConfig.wrap;
        }
        return newConfig;
    }
}
...
function instanceOfSwipeNavigationConfig(obj) {
    return SwipeNavigationConfigSchema.safeParse(obj).success;
}

class PageObject {
    constructor(selectorsPaths) {
        this.domNodes = [];
        this.observers = [];
        this.domNodeAddedCallbacks = [];
        this.domNodeRemovedCallbacks = [];
        this.selectorPaths = selectorsPaths;
        this.domNodes = new Array(this.selectorPaths.length);
        this.observers = new Array(this.selectorPaths.length);
    }
    addDomNodeAddedCallback(callback) {
    ...
    getDomNode() {
        ...
        return this.getDomNodeAt(last); // TODO change
    }
    /**
    ...
    getDomNodeAt(index) {
        ...
        if ((domNode === null || domNode === undefined ? undefined : domNode.isConnected) == true) {
            return domNode;
        }
        ...
        if (this.selectorPaths[index] == "$") {
            ...
            this.domNodes[index] = (_a = currentRootNode === null || currentRootNode === undefined ? undefined : currentRootNode.querySelector(this.selectorPaths[index])) !== null && _a !== undefined ? _a : null;
        }
        return this.domNodes[index];
    }
    createNodeObserversFrom(index) {
        var _a;
        ...
        if (currentRootNode != null) {
            ...
            (_a = this.observers[index]) === null || _a === undefined ? undefined : _a.observe(currentRootNode, {
                childList: true,
    ...
    destroyNodeObserversFrom(index) {
        var _a;
        if (this.observers[index] != null) {
            (_a = this.observers[index]) === null || _a === undefined ? undefined : _a.disconnect();
    ...
    invalidateDomNodesFrom(index) {
        this.domNodes[index] = null;
        if (index < this.domNodes.length - 1) {
            this.invalidateDomNodesFrom(index + 1);
        }
    }
    invokeDomNodeAddedCallbacks(domNode) {
        for (const callback of this.domNodeAddedCallbacks) {
            callback(domNode);
        }
    }
    invokeDomNodeRemovedCallbacks() {
...
function getCurrentHAVersion() {
    var _a, _b, _c;
    return ((_c = (_b = (_a = document.getElementsByTagName("home-assistant")[0]) === null || _a === undefined ? undefined : _a.hass) === null || _b === undefined ? undefined : _b.config) === null || _c === undefined ? undefined : _c.version) || null;
}
...
PageObjectManager.ha = new PageObject([
    "home-assistant"
]);
PageObjectManager.haMain = new PageObject([
    ...PageObjectManager.ha.getSelectorPaths(),
    "$",
    "home-assistant-main"
]);
PageObjectManager.partialPanelResolver = new PageObject([
    ...PageObjectManager.haMain.getSelectorPaths(),
    "$",
    "partial-panel-resolver"
]);
PageObjectManager.haPanelLovelace = new PageObject([
    ...PageObjectManager.partialPanelResolver.getSelectorPaths(),
    "ha-panel-lovelace"
]);
PageObjectManager.huiRoot = new PageObject([
    ...PageObjectManager.haPanelLovelace.getSelectorPaths(),
    "$",
    "hui-root"
]);
PageObjectManager.haAppLayout = new PageObject([
    ...PageObjectManager.huiRoot.getSelectorPaths(),
    "$",
    (isLessThan2023_4() ? "ha-app-layout" : "div")
]);
PageObjectManager.haAppLayoutView = new PageObject([
    ...PageObjectManager.huiRoot.getSelectorPaths(),
    "$",
    "[id=\"view\"]"
]);
...
class ConfigManager {
    ...
    static getViews() {
        var _a, _b;
        const haPanelLovelace = PageObjectManager.haPanelLovelace.getDomNode();
        const views = (_b = (_a = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.lovelace) === null || _a === undefined ? undefined : _a.config) === null || _b === undefined ? undefined : _b.views;
        if (views != null) {
    ...
    static getCurrentViewName() {
        var _a, _b, _c;
        const haPanelLovelace = PageObjectManager.haPanelLovelace.getDomNode();
        return (_c = (_b = (_a = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.route) === null || _a === undefined ? undefined : _a.path) === null || _b === undefined ? undefined : _b.replace("/", "")) !== null && _c !== undefined ? _c : null;
    }
    static getCurrentViewIndex() {
    ...
    static isViewVisible(views, index) {
        ...
        const exhaustiveCheck = visibleOrEnabledUsers;
        throw new Error(`Unhandled case: ${exhaustiveCheck}`);
    }
    static isViewHidden(views, index) {
    ...
    static readAndMonitorConfig() {
        return __awaiter(this, undefined, undefined, function* () {
            ...
            yield ConfigManager.readConfig();
        });
    }
    static registerConfigObserver(configObserver) {
        ConfigManager.configObservers.push(configObserver);
    }
    static unregisterConfigObserver(configObserver) {
    ...
    static readConfig() {
        return __awaiter(this, undefined, undefined, function* () {
            ...
            const haPanelLovelace = PageObjectManager.haPanelLovelace.getDomNode();
            const rawConfig = (_c = (_b = (_a = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.lovelace) === null || _a === undefined ? undefined : _a.config) === null || _b === undefined ? undefined : _b.swipe_nav) !== null && _c !== undefined ? _c : {};
            if (JSON.stringify(rawConfig) != JSON.stringify(ConfigManager.rawConfig)) {
                ConfigManager.saveConfig(rawConfig);
            }
            const panel = (_d = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.route) === null || _d === undefined ? undefined : _d.prefix;
            if (panel != null) {
                ConfigManager.panel = panel.replace("/", "");
            }
            const views = (_f = (_e = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.lovelace) === null || _e === undefined ? undefined : _e.config) === null || _f === undefined ? undefined : _f.views;
            if (views != null) {
                ConfigManager.views = views;
            }
            const currentUserId = (_h = (_g = haPanelLovelace === null || haPanelLovelace === undefined ? undefined : haPanelLovelace.hass) === null || _g === undefined ? undefined : _g.user) === null || _h === undefined ? undefined : _h.id;
            if (currentUserId != null) {
                ConfigManager.currentUserId = currentUserId;
            }
        });
    }
    static saveConfig(rawConfig) {
...
ConfigManager.panel = null;
ConfigManager.views = null;
ConfigManager.currentUserId = null;
ConfigManager.rawConfig = null;
ConfigManager.configObservers = [];
...
var _a, _SwipeManager_xDown, _SwipeManager_yDown, _SwipeManager_xDiff, _SwipeManager_yDiff, _SwipeManager_pointerEventsAbortController, _SwipeManager_handlePointerStart, _SwipeManager_handlePointerMove, _SwipeManager_handlePointerEnd, _SwipeManager_getNextViewName;
class SwipeManager {
    static init() {
        var _b;
        (_b = __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController)) === null || _b === undefined ? undefined : _b.abort();
        __classPrivateFieldSet$1(this, _a, new AbortController(), "f", _SwipeManager_pointerEventsAbortController);
        ...
        if (haAppLayoutDomNode != null) {
            ...
            haAppLayoutDomNode.addEventListener("touchstart", (event) => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerStart).call(this, event); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: true });
            haAppLayoutDomNode.addEventListener("touchmove", (event) => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerMove).call(this, event); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: false });
            haAppLayoutDomNode.addEventListener("touchend", () => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerEnd).call(this); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: true });
            haAppLayoutDomNode.addEventListener("mousedown", (event) => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerStart).call(this, event); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: true });
            if (ConfigManager.getCurrentConfig().getEnableMouseSwipe()) {
                haAppLayoutDomNode.addEventListener("mousemove", (event) => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerMove).call(this, event); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: false });
                haAppLayoutDomNode.addEventListener("mouseup", () => { __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_handlePointerEnd).call(this); }, { signal: __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_pointerEventsAbortController).signal, passive: true });
            }
        }
    }
    static animatedNavigateTo(viewName, directionLeft) {
        ...
        if (view == null) {
            ...
            if (configAnimate == "none") {
                ...
                if (configAnimate == "swipe") {
                    ...
                    const exhaustiveCheck = configAnimate;
                    throw new Error(`Unhandled case: ${exhaustiveCheck}`);
                }
                setTimeout(function () {
...
_a = SwipeManager, _SwipeManager_handlePointerStart = function _SwipeManager_handlePointerStart(event) {
    let interactionType;
    ...
    if (window.TouchEvent != null && event instanceof TouchEvent && event.touches.length > 1) {
        __classPrivateFieldSet$1(this, _a, null, "f", _SwipeManager_xDown);
        __classPrivateFieldSet$1(this, _a, null, "f", _SwipeManager_yDown);
    ...
    if (window.TouchEvent != null && event instanceof TouchEvent) {
        __classPrivateFieldSet$1(this, _a, event.touches[0].clientX, "f", _SwipeManager_xDown);
        __classPrivateFieldSet$1(this, _a, event.touches[0].clientY, "f", _SwipeManager_yDown);
    }
    else if (event instanceof MouseEvent) {
        __classPrivateFieldSet$1(this, _a, event.clientX, "f", _SwipeManager_xDown);
        __classPrivateFieldSet$1(this, _a, event.clientY, "f", _SwipeManager_yDown);
    }
    else {
        const eventCheck /*: never*/ = event; // Firefox doesn't always set TouchEvent type
        throw new Error(`Unhandled case: ${eventCheck}`);
    }
}, _SwipeManager_handlePointerMove = function _SwipeManager_handlePointerMove(event) {
    if (__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDown) && __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDown)) {
        if (window.TouchEvent != null && event instanceof TouchEvent) {
            __classPrivateFieldSet$1(this, _a, __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDown) - event.touches[0].clientX, "f", _SwipeManager_xDiff);
            __classPrivateFieldSet$1(this, _a, __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDown) - event.touches[0].clientY, "f", _SwipeManager_yDiff);
        }
        else if (event instanceof MouseEvent) {
            __classPrivateFieldSet$1(this, _a, __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDown) - event.clientX, "f", _SwipeManager_xDiff);
            __classPrivateFieldSet$1(this, _a, __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDown) - event.clientY, "f", _SwipeManager_yDiff);
        }
        else {
            const eventCheck /*: never*/ = event; // Firefox doesn't always set TouchEvent type
            throw new Error(`Unhandled case: ${eventCheck}`);
        }
        if (Math.abs(__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDiff)) > Math.abs(__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDiff)) && ConfigManager.getCurrentConfig().getPreventDefault())
            event.preventDefault();
    }
}, _SwipeManager_handlePointerEnd = function _SwipeManager_handlePointerEnd() {
    var _b;
    if (__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDiff) != null && __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDiff) != null) {
        if (Math.abs(__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDiff)) < Math.abs(__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_yDiff))) {
            Logger.logd(LOG_TAG, "Swipe ignored, vertical movement.");
        }
        else { // Horizontal movement
            if (Math.abs(__classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDiff)) < Math.abs(screen.width * ConfigManager.getCurrentConfig().getSwipeAmount())) {
                Logger.logd(LOG_TAG, "Swipe ignored, too short.");
            }
            else {
                const directionLeft = __classPrivateFieldGet$1(this, _a, "f", _SwipeManager_xDiff) < 0;
                Logger.logi(LOG_TAG, "Swipe detected, changing tab to the " + (directionLeft ? "left" : "right") + ".");
                const rtl = ((_b = PageObjectManager.ha.getDomNode()) === null || _b === undefined ? undefined : _b.style.direction) == "rtl";
                const nextViewName = __classPrivateFieldGet$1(this, _a, "m", _SwipeManager_getNextViewName).call(this, rtl ? !directionLeft : directionLeft);
    ...
    __classPrivateFieldSet$1(this, _a, __classPrivateFieldSet$1(this, _a, __classPrivateFieldSet$1(this, _a, __classPrivateFieldSet$1(this, _a, null, "f", _SwipeManager_yDiff), "f", _SwipeManager_xDiff), "f", _SwipeManager_yDown), "f", _SwipeManager_xDown);
}, _SwipeManager_getNextViewName = function _SwipeManager_getNextViewName(directionLeft) {
    const views = ConfigManager.getViews();
    const activeTabIndex = ConfigManager.getCurrentViewIndex();
...
_SwipeManager_xDown = { value: undefined };
_SwipeManager_yDown = { value: undefined };
_SwipeManager_xDiff = { value: undefined };
_SwipeManager_yDiff = { value: undefined };
_SwipeManager_pointerEventsAbortController = { value: null };
...
function run() {
    return __awaiter(this, undefined, undefined, function* () {
        ...
        yield ConfigManager.readAndMonitorConfig();
...
// Initial run
void run();
//# sourceMappingURL=swipe-navigation.js.map
